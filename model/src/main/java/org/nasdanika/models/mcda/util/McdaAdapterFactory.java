...
public class McdaAdapterFactory extends AdapterFactoryImpl {
	...
	protected McdaSwitch<Adapter> modelSwitch =
		new McdaSwitch<Adapter>() {
			...
			@Override
			public Adapter caseComparable(org.nasdanika.models.mcda.Comparable object) {
			...
			@Override
			public Adapter caseExpert(Expert object) {
				return createExpertAdapter();
			}
			@Override
			public Adapter caseExpertGroup(ExpertGroup object) {
				return createExpertGroupAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseJudgment(Judgment object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.mcda.Evaluation <em>Evaluation</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.mcda.Comparable <em>Comparable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.mcda.Expert <em>Expert</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExpertAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.mcda.ExpertGroup <em>Expert Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExpertGroupAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.mcda.Alternative <em>Alternative</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.mcda.Judgment <em>Judgment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
